...
export const MsgBurnToken: MessageFns<MsgBurnToken> = {
  ...
  create<I extends Exact<DeepPartial<MsgBurnToken>, I>>(
    base?: I
  ): MsgBurnToken {
...
export const MsgBurnTokenResponse: MessageFns<MsgBurnTokenResponse> = {
  ...
  create<I extends Exact<DeepPartial<MsgBurnTokenResponse>, I>>(
    base?: I
  ): MsgBurnTokenResponse {
...
export class MsgClientImpl implements Msg {
  ...
  BurnToken(request: MsgBurnToken): Promise<MsgBurnTokenResponse> {
    ...
    return promise.then((data) =>
      MsgBurnTokenResponse.decode(new BinaryReader(data))
    )
  }
