...
export const QueryParamsResponse: MessageFns<QueryParamsResponse> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.storeCodeBaseGas = Long.fromString(
        ...
        case 2: {
          ...
          message.storeCodeMultiplier = Long.fromString(
            reader.uint64().toString(),
            true
          )
          continue
        ...
        case 3: {
          ...
          message.instBaseGas = Long.fromString(
            reader.uint64().toString(),
            true
          )
          continue
        ...
        case 4: {
          ...
          message.instMultiplier = Long.fromString(
            reader.uint64().toString(),
            true
          )
          continue
  ...
  fromJSON(object: any): QueryParamsResponse {
    return {
      storeCodeBaseGas: isSet(object.storeCodeBaseGas)
        ? Long.fromValue(object.storeCodeBaseGas)
        : Long.UZERO,
      storeCodeMultiplier: isSet(object.storeCodeMultiplier)
        ? Long.fromValue(object.storeCodeMultiplier)
        : Long.UZERO,
      instBaseGas: isSet(object.instBaseGas)
        ? Long.fromValue(object.instBaseGas)
        : Long.UZERO,
      instMultiplier: isSet(object.instMultiplier)
  ...
  toJSON(message: QueryParamsResponse): unknown {
    ...
    if (!message.storeCodeMultiplier.equals(Long.UZERO)) {
      obj.storeCodeMultiplier = (
        message.storeCodeMultiplier || Long.UZERO
      ).toString()
    }
    if (!message.instBaseGas.equals(Long.UZERO)) {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryParamsResponse>, I>>(
    ...
    const message = createBaseQueryParamsResponse()
    message.storeCodeBaseGas =
      object.storeCodeBaseGas !== undefined && object.storeCodeBaseGas !== null
        ? Long.fromValue(object.storeCodeBaseGas)
        : Long.UZERO
    message.storeCodeMultiplier =
      object.storeCodeMultiplier !== undefined &&
      object.storeCodeMultiplier !== null
        ? Long.fromValue(object.storeCodeMultiplier)
        : Long.UZERO
    message.instBaseGas =
      object.instBaseGas !== undefined && object.instBaseGas !== null
        ? Long.fromValue(object.instBaseGas)
        : Long.UZERO
    message.instMultiplier =
      object.instMultiplier !== undefined && object.instMultiplier !== null
        ? Long.fromValue(object.instMultiplier)
        : Long.UZERO
    return message
  },
