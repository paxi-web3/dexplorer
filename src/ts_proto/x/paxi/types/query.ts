...
export const QueryLockedVestingRequest: MessageFns<QueryLockedVestingRequest> =
  {
    ...
    create<I extends Exact<DeepPartial<QueryLockedVestingRequest>, I>>(
      base?: I
    ): QueryLockedVestingRequest {
      return QueryLockedVestingRequest.fromPartial(base ?? ({} as any))
    },
    fromPartial<I extends Exact<DeepPartial<QueryLockedVestingRequest>, I>>(
      _: I
    ): QueryLockedVestingRequest {
      const message = createBaseQueryLockedVestingRequest()
      return message
...
export const QueryLockedVestingResponse: MessageFns<QueryLockedVestingResponse> =
  {
    ...
    create<I extends Exact<DeepPartial<QueryLockedVestingResponse>, I>>(
      base?: I
    ): QueryLockedVestingResponse {
      return QueryLockedVestingResponse.fromPartial(base ?? ({} as any))
    },
    fromPartial<I extends Exact<DeepPartial<QueryLockedVestingResponse>, I>>(
      object: I
    ): QueryLockedVestingResponse {
      const message = createBaseQueryLockedVestingResponse()
      message.amount =
...
export const QueryCirculatingSupplyResponse: MessageFns<QueryCirculatingSupplyResponse> =
  {
    ...
    fromPartial<
      I extends Exact<DeepPartial<QueryCirculatingSupplyResponse>, I>
    >(object: I): QueryCirculatingSupplyResponse {
      const message = createBaseQueryCirculatingSupplyResponse()
      message.amount =
        object.amount !== undefined && object.amount !== null
          ? Coin.fromPartial(object.amount)
...
export const QueryEstimatedGasPriceRequest: MessageFns<QueryEstimatedGasPriceRequest> =
  {
    encode(
      _: QueryEstimatedGasPriceRequest,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      return writer
    },
    ...
    create<I extends Exact<DeepPartial<QueryEstimatedGasPriceRequest>, I>>(
      base?: I
    ): QueryEstimatedGasPriceRequest {
      return QueryEstimatedGasPriceRequest.fromPartial(base ?? ({} as any))
    },
    fromPartial<I extends Exact<DeepPartial<QueryEstimatedGasPriceRequest>, I>>(
      _: I
    ): QueryEstimatedGasPriceRequest {
      const message = createBaseQueryEstimatedGasPriceRequest()
      return message
...
export const QueryEstimatedGasPriceResponse: MessageFns<QueryEstimatedGasPriceResponse> =
  {
    ...
    create<I extends Exact<DeepPartial<QueryEstimatedGasPriceResponse>, I>>(
      base?: I
    ): QueryEstimatedGasPriceResponse {
      return QueryEstimatedGasPriceResponse.fromPartial(base ?? ({} as any))
    },
    fromPartial<
      I extends Exact<DeepPartial<QueryEstimatedGasPriceResponse>, I>
    >(object: I): QueryEstimatedGasPriceResponse {
      const message = createBaseQueryEstimatedGasPriceResponse()
...
export const QueryLastBlockGasUsedRequest: MessageFns<QueryLastBlockGasUsedRequest> =
  {
    encode(
      _: QueryLastBlockGasUsedRequest,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      return writer
    },
    ...
    create<I extends Exact<DeepPartial<QueryLastBlockGasUsedRequest>, I>>(
      base?: I
    ): QueryLastBlockGasUsedRequest {
      return QueryLastBlockGasUsedRequest.fromPartial(base ?? ({} as any))
    },
    fromPartial<I extends Exact<DeepPartial<QueryLastBlockGasUsedRequest>, I>>(
      _: I
    ): QueryLastBlockGasUsedRequest {
      const message = createBaseQueryLastBlockGasUsedRequest()
      return message
...
export const QueryLastBlockGasUsedResponse: MessageFns<QueryLastBlockGasUsedResponse> =
  {
    ...
    create<I extends Exact<DeepPartial<QueryLastBlockGasUsedResponse>, I>>(
      base?: I
    ): QueryLastBlockGasUsedResponse {
...
export const QueryTotalTxsRequest: MessageFns<QueryTotalTxsRequest> = {
  ...
  create<I extends Exact<DeepPartial<QueryTotalTxsRequest>, I>>(
    base?: I
  ): QueryTotalTxsRequest {
    return QueryTotalTxsRequest.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<QueryTotalTxsRequest>, I>>(
    _: I
  ): QueryTotalTxsRequest {
    const message = createBaseQueryTotalTxsRequest()
    return message
...
export const QueryTotalTxsResponse: MessageFns<QueryTotalTxsResponse> = {
  ...
  create<I extends Exact<DeepPartial<QueryTotalTxsResponse>, I>>(
    base?: I
  ): QueryTotalTxsResponse {
    return QueryTotalTxsResponse.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<QueryTotalTxsResponse>, I>>(
    object: I
  ): QueryTotalTxsResponse {
    const message = createBaseQueryTotalTxsResponse()
    message.totalTxs =
...
export const UnlockSchedule: MessageFns<UnlockSchedule> = {
  ...
  fromJSON(object: any): UnlockSchedule {
    return {
      ...
      timeUnix: isSet(object.timeUnix)
  ...
  create<I extends Exact<DeepPartial<UnlockSchedule>, I>>(
    base?: I
  ): UnlockSchedule {
    return UnlockSchedule.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<UnlockSchedule>, I>>(
    object: I
  ): UnlockSchedule {
    const message = createBaseUnlockSchedule()
    ...
    message.timeUnix =
      object.timeUnix !== undefined && object.timeUnix !== null
        ? Long.fromValue(object.timeUnix)
        : Long.ZERO
    message.amount =
      object.amount !== undefined && object.amount !== null
...
export const QueryUnlockSchedulesRequest: MessageFns<QueryUnlockSchedulesRequest> =
  {
    ...
    create<I extends Exact<DeepPartial<QueryUnlockSchedulesRequest>, I>>(
      base?: I
    ): QueryUnlockSchedulesRequest {
      return QueryUnlockSchedulesRequest.fromPartial(base ?? ({} as any))
    },
    fromPartial<I extends Exact<DeepPartial<QueryUnlockSchedulesRequest>, I>>(
      _: I
    ): QueryUnlockSchedulesRequest {
      const message = createBaseQueryUnlockSchedulesRequest()
      return message
...
export const QueryUnlockSchedulesResponse: MessageFns<QueryUnlockSchedulesResponse> =
  {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            message.unlockSchedules.push(
              UnlockSchedule.decode(reader, reader.uint32())
            )
            continue
          }
        }
    ...
    toJSON(message: QueryUnlockSchedulesResponse): unknown {
      ...
      if (message.unlockSchedules?.length) {
        obj.unlockSchedules = message.unlockSchedules.map((e) =>
          UnlockSchedule.toJSON(e)
        )
      }
      return obj
    },

    create<I extends Exact<DeepPartial<QueryUnlockSchedulesResponse>, I>>(
      base?: I
    ): QueryUnlockSchedulesResponse {
      return QueryUnlockSchedulesResponse.fromPartial(base ?? ({} as any))
    },
    fromPartial<I extends Exact<DeepPartial<QueryUnlockSchedulesResponse>, I>>(
      object: I
    ): QueryUnlockSchedulesResponse {
      const message = createBaseQueryUnlockSchedulesResponse()
      message.unlockSchedules =
        object.unlockSchedules?.map((e) => UnlockSchedule.fromPartial(e)) || []
      return message
    },
  }
...
export const QueryParamsResponse: MessageFns<QueryParamsResponse> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.extraGasPerNewAccount = Long.fromString(
  ...
  toJSON(message: QueryParamsResponse): unknown {
    const obj: any = {}
    if (!message.extraGasPerNewAccount.equals(Long.UZERO)) {
      obj.extraGasPerNewAccount = (
        message.extraGasPerNewAccount || Long.UZERO
      ).toString()
    }
    return obj
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryParamsResponse>, I>>(
    ...
    message.extraGasPerNewAccount =
      object.extraGasPerNewAccount !== undefined &&
      object.extraGasPerNewAccount !== null
        ? Long.fromValue(object.extraGasPerNewAccount)
        : Long.UZERO
    return message
  },
...
export interface Query {
  LockedVesting(
    request: QueryLockedVestingRequest
  ...
  EstimatedGasPrice(
    request: QueryEstimatedGasPriceRequest
  ): Promise<QueryEstimatedGasPriceResponse>
  LastBlockGasUsed(
    request: QueryLastBlockGasUsedRequest
  ): Promise<QueryLastBlockGasUsedResponse>
  TotalTxs(request: QueryTotalTxsRequest): Promise<QueryTotalTxsResponse>
  UnlockSchedules(
    request: QueryUnlockSchedulesRequest
  ): Promise<QueryUnlockSchedulesResponse>
...
export class QueryClientImpl implements Query {
  ...
  LockedVesting(
    ...
    return promise.then((data) =>
      QueryLockedVestingResponse.decode(new BinaryReader(data))
    )
  }
  ...
  CirculatingSupply(
    ...
    return promise.then((data) =>
      QueryCirculatingSupplyResponse.decode(new BinaryReader(data))
    )
  }
  ...
  EstimatedGasPrice(
    ...
    return promise.then((data) =>
      QueryEstimatedGasPriceResponse.decode(new BinaryReader(data))
    )
  }
  ...
  LastBlockGasUsed(
    ...
    return promise.then((data) =>
      QueryLastBlockGasUsedResponse.decode(new BinaryReader(data))
    )
  }
  ...
  TotalTxs(request: QueryTotalTxsRequest): Promise<QueryTotalTxsResponse> {
    ...
    return promise.then((data) =>
      QueryTotalTxsResponse.decode(new BinaryReader(data))
    )
  }
  ...
  UnlockSchedules(
    ...
    return promise.then((data) =>
      QueryUnlockSchedulesResponse.decode(new BinaryReader(data))
    )
  }
